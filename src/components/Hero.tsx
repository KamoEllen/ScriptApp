...
export const Hero = () => {
  return (
    <section className="container grid lg:grid-cols-2 place-items-center py-20 md:py-32 gap-10">
      ...
      <a target="_blank" rel="noreferrer" href="https://thescriptapp.com" className="mx-auto flex max-w-fit items-center justify-center overflow-hidden rounded-full bg-blue-100 px-7 py-2 transition-all hover:bg-blue-200">
