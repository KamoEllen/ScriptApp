                    ...
                    {resources.map((resource) => (
                        <div key={resource.id} className={`bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden`}>
                            ...
                            <div className="p-4 md:p-6">
                                ...
                                <button onClick={() => openPopup(resource.learnMoreUrl)} className={`inline-block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full `}>Watch Video</button>
                            </div>
                        </div>
                    ))}
                </div>
