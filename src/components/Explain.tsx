                    ...
                    {resources.map((resource) => (
                        <div key={resource.id} className={`bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden`}>
                            ...
                            <div className="p-4 md:p-6">
                                ...
                                <a href={resource.learnMoreUrl} className={`inline-block bg-${resource.color}-500 hover:bg-green-600 text-secondary px-4 py-2 rounded-full`}>Learn More</a>
                                <button onClick={() => openPopup(resource.learnMoreUrl)} className={`inline-block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full ml-2`}>Watch Video</button>
                            </div>
                        </div>
                    ))}
                </div>
