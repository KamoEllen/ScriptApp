  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white dark:border-b-slate-700 dark:bg-background">
      <NavigationMenu className="mx-auto">
        <NavigationMenuList className="container h-14 px-4 md:px-0 max-w-screen-lg mx-auto flex justify-between items-center">
          ...
          <span className="flex md:hidden items-center">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              <SheetTrigger className="px-2" onClick={() => setIsOpen(!isOpen)}>
